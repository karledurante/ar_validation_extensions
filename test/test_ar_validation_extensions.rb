...
class TestArValidationExtensions < Test::Unit::TestCase
  
  context "When loading ArValidationExtensions" do
    context "with valid configurations" do
      setup { @fields = ArValidationExtensions::Config.values.keys }
